...
namespace Analyze.Shared.Bussiness.Services
{
    public class BaseService : IBaseService
    {
        ...
        public void Update<T>(T t) where T : class
        {
            ...
            this.Context.Set<T>().Attach(t);//将数据附件到上下文，支持实体修改和新实体，重置为UnChanged
        ...
        public IQueryable<T> ExcuteQuery<T>(string sql, MySqlParameter[] parameters) where T : class 
        {
            return this.Context.Database.SqlQuery<T>(sql, parameters).AsQueryable();
        }

        public void Excute<T>(string sql, MySqlParameter[] parameters) where T : class 
        {
